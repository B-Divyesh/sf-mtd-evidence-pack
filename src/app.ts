...
function footer(): string {
  return `<footer class="site-footer"><p>Prepare a quarterly evidence pack on your device.<span class="art-credit">Hero artwork was generated for this product.</span></p><nav aria-label="Footer navigation"><a href="/privacy" data-link>Privacy</a><a href="/terms" data-link>Terms</a><a href="https://sociobot.in" rel="external">Built by Param Factory <span class="sr-only">(external site)</span></a></nav><p class="build-id">v1.0.12</p></footer>`;
}
...
function workspacePage(): string {
  ...
  const supportNotice = licensed || demoMode ? `<p class="licensed-note">Existing licence features are available${demoMode ? " in this sample" : ""}.</p>` : `<div class="support-nudge">${licenseNotice ? `<p><strong>${escapeHtml(licenseNotice)}</strong></p>` : ""}<p><strong>Already have an existing licence?</strong></p><p>Verify it to restore saved cover notes. Record imports, source-file attachments, and encrypted evidence pack export stay free.</p><form data-form="restore-license" class="restore-form"><label for="workspace-license">Paste your licence</label><input id="workspace-license" name="license" autocomplete="off" required><button class="button small" type="submit" aria-label="Verify licence">Verify licence</button></form></div>`;
